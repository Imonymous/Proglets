...
- (void)record:(id)sender {
    ...
    if ( _recorder ) {
        ...
        // Make a new Filename
        NSString *loop = [NSString stringWithFormat:@"%d/%d.aiff", [appDelegate currentPostOnEdit], m_loopCounter];
...
- (void)play:(id)sender {
    ...
    if ( m_looping ) {
        ...
        for (int i = 0; i <= m_loopCounter; i++)
        {
            ...
            // For each File
            NSString *loopFile = [NSString stringWithFormat:@"%d/%d.aiff", [appDelegate currentPostOnEdit], m_loopCounter];
    ...
    switch ( indexPath.section ) {
        case 0: {
            ...
            switch ( indexPath.row ) {
                case 0: {
                    UIView *oscilView = [[UIView alloc] initWithFrame:CGRectMake(0, 0, cell.bounds.size.width, 200)];
                    ...
                    _inputOscilloscope.frame = CGRectMake(0, 0, oscilView.bounds.size.width, 100);
                    ...
                    _outputOscilloscope.frame = CGRectMake(0, 100, oscilView.bounds.size.width, 100);
                ...
                case 1: {
                    UIView *controlsView = [[[UIView alloc] initWithFrame:CGRectMake(0, 100, cell.bounds.size.width, 50)] autorelease];
